...
namespace ConsoleApplication39
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            MyCalc(a, b, out sum, out prod); // calling of mycalc method in our main function

            Console.WriteLine("Sum of {2} + {3} = {0} and Product of {2} * {3}  ={1}", sum, prod, a, b); /// printing out result of calling MyCalc
        ...
        // defining mycalc function to be called in our mainfunction
        {
            sum = x + y;
            prod = x * y;
